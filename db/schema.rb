...
ActiveRecord::Schema.define(version: 2020_11_27_134446) do
  ...
  create_table "entries", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.boolean "room_status", default: false, null: false
    t.index ["public_uid"], name: "index_entries_on_public_uid", unique: true
  ...
  create_table "rooms", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.string "public_uid"
    t.index ["public_uid"], name: "index_rooms_on_public_uid", unique: true
  end
